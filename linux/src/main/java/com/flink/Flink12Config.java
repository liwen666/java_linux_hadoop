...
public class Flink12Config {
    ...
    public void installRedis() throws Exception {
        ...
        if (getConfigs) {
            ...
            fileManager.getLinuxFileCategory("flink12", "192.168.60.100", "root", "root", 22, "flink-conf.yaml", "/home/liwen/flink12/flink12/conf", new HashMap() {{
                put("file_linux_cfg", filePath);
            }});
            fileManager.getLinuxFileCategory("flink12", "192.168.60.100", "root", "root", 22, "masters", "/home/liwen/flink12/flink12/conf", new HashMap() {{
                put("file_linux_cfg", filePath);
            }});
            fileManager.getLinuxFileCategory("flink12", "192.168.60.100", "root", "root", 22, "workers", "/home/liwen/flink12/flink12/conf", new HashMap() {{
                put("file_linux_cfg", filePath);
            }});
            fileManager.getLinuxFileCategory("flink12", "192.168.60.100", "root", "root", 22, "zoo.cfg", "/home/liwen/flink12/flink12/conf", new HashMap() {{
                put("file_linux_cfg", filePath);
            }});
//
...
//            }});
            ...
            fileManager.upLinuxFileCategory("flink12", "192.168.60.100", "root", "root", 22, "flink-conf.yaml");
            fileManager.upLinuxFileCategory("flink12", "192.168.60.100", "root", "root", 22, "masters");
            fileManager.upLinuxFileCategory("flink12", "192.168.60.100", "root", "root", 22, "workers");
