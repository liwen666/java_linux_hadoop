package com.java.hadoop.linux.nacos;
...
//			上传java文件 到hadoop用户目录
            ...
            for (Object str : ls) {
                ...
                if(cl.getLongname().endsWith("nacos-server-1.3.1.tar.gz")){
                    System.out.println(str+"   nacos 已经被安装");
            ...
            if(!mark){
                File javaFile = new File("D:\\系统预装\\开发安装包\\nacos\\nacos-server-1.3.1.tar.gz");
           ...
           /****************************解压java文件***********************/
            if(!mark){
                String s1 = executeShell("mkdir -vp /home/liwen/nacos");
                System.out.println(s1+"创建目录");
                String s2 = executeShell("tar zxvf /home/liwen/nacos-server-1.3.1.tar.gz -C /home/liwen/nacos");
                System.out.println("解压nacos_____________________"+s2);
            }
           /****************************解压java文件***********************/
