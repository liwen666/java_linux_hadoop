...
public class PgsqlSite {
    public static void main(String[] args) throws Exception {
        ...
        //从服务器配置
//        配置server.properties
//        fileManager.getLinuxFileCategory("192.168.42.136","root","root",22,"postgresql.conf","/var/lib/pgsql/data");
//        fileManager.getLinuxFileCategory("192.168.42.136","root","root",22,"pg_hba.conf","/var/lib/pgsql/data");
