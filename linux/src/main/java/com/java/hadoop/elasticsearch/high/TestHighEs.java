package com.java.hadoop.elasticsearch.high;
 ...
 *
 * @author LW
 * @since 2020/12/3  15:05
 */
public class TestHighEs {
    public static void main(String[] args) throws IOException {
//        RestHighLevelClient client = new RestHighLevelClient(
//                RestClient.builder(
//                        new HttpHost("10.0.8.11", 9200, "http")));
...
//                       new HttpHost("localhost", 9200, "http"),
  ...
  /*    //异步执行删除索引请求需要将DeleteIndexRequest实例和ActionListener实例传递给异步方法：
       ...
       boolean acknowledged = delete.isAcknowledged();//是否所有节点都已确认请求
...
//                       new HttpHost("localhost", 9200, "http"),
       ...
       OpenIndexRequest request = new OpenIndexRequest("twitter_two");//打开索引
       //可选参数：
  ...
  public  void closeIndex() throws IOException {
      ...
      request.indicesOptions(IndicesOptions.lenientExpandOpen());
      //同步执行
       AcknowledgedResponse close = client.indices().close(request);
      ...
      boolean acknowledged = close.isAcknowledged(); //指示是否所有节点都已确认请求
  }
...
//                        new HttpHost("localhost", 9200, "http"),
        ...
        GetRequest request = new GetRequest("twitter_two", "tweet", "1");
        try {
