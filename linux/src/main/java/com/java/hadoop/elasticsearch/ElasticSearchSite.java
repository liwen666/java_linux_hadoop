...
//        String filePath="/home/elasticsearch/elasticsearch-6.5.4/config";
        String filePath="/home/elasticsearch/elasticsearch-6.1.1/config";
...
//        fileManager.getLinuxFileCategory("192.168.42.220","elasticsearch","elasticsearch",22,"elasticsearch","/home/elasticsearch/elasticsearch-6.5.4/bin");
        fileManager.getLinuxFileCategory("est_center", "192.168.42.220","elasticsearch","elasticsearch",22,"elasticsearch.yml","/home/elasticsearch/elasticsearch-6.1.1/config",null);
//        7.配置slaves 文件
//         /设置内核参数
//        fileManager.getLinuxFileCategory("192.168.42.220","root","root",22,"sysctl.conf","/etc/");
//        fileManager.getLinuxFileCategory("192.168.42.220","root","root",22,"limits.conf","/etc/security/");
//        fileManager.getLinuxFileCategory("192.168.42.220","root","root",22,"20-nproc.conf","/etc/security/limits.d/");
//        fileManager.getLinuxFileCategory("192.168.42.220","root","root",22,"20-nproc.conf","/etc/security/limits.d/");



//        fileManager.upLinuxFileCategory("192.168.42.220","elasticsearch","elasticsearch",22,"jvm.options");
//        fileManager.upLinuxFileCategory("192.168.42.220","elasticsearch","elasticsearch",22,"elasticsearch.yml");
//        fileManager.upLinuxFileCategory("192.168.42.220","root","root",22,"sysctl.conf");
//        fileManager.upLinuxFileCategory("192.168.42.220","root","root",22,"limits.conf");
