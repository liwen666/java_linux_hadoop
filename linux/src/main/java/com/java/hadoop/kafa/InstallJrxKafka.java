...
//			上传zookeeper文件 到jrxany用户目录
             ...
             * 初始化目录
             */
            String s0 = executeShell("mkdir -vp   /home/jrxany/batch_node/kafka/{data,logs}");
            System.out.println(s0);

            sftp.cd("/home/jrxany/batch_node/kafka");
            ...
            boolean mark = false;
            Vector ls = sftp.ls("/home/jrxany/batch_node/kafka");
            for (Object str : ls) {
                ChannelSftp.LsEntry cl = (ChannelSftp.LsEntry) str;
                if(cl.getLongname().endsWith("kafka_2.12-2.1.1.tgz")){
                    System.out.println(str+"   kafka 已经被安装");
            ...
            if(!mark){
                File zookeeper = new File("G:/开发安装包/大数据分布式需要的技术/kafka_2.12-2.1.1.tgz");
           ...
           /****************************解压java文件***********************/
            if(!mark){
                String s2 = executeShell("tar zxvf /home/jrxany/batch_node/kafka/kafka_2.12-2.1.1.tgz  -C /home/jrxany/batch_node/kafka");
