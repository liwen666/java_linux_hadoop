...
# OS specific support.  $var _must_ be set to either true or false. 远程调用配置
export JAVA_OPTS='-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8100 -Xmx512m -Xmx512m -XX:PermSize=550m -XX:MaxPermSize=1250m'
cygwin=false
darwin=false
os400=false
hpux=false
