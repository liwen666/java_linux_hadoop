...
public class AnyData {
    ...
    public static void main(String[] args) throws Exception {
        String filePath="/home/jrxany/any_est/anydata-server-3.4.0-SNAPSHOT/config";
//        String filePath="/home/jrxany/est_test/anydata-server-3.3.1/config";
        ...
        //从服务器配置
//        fileManager.getLinuxFileCategory("10.0.2.15","jrxany","JRXwd01!",22,"application-local_data.yml",filePath);
