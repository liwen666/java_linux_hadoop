...
public class HIVESite {
    public static void main(String[] args) throws Exception {
        ...
        String filePath="/usr/local/hive/conf";
        FileManager fileManager = new FileManager();
        /**
         * 下载
         */
//        fileManager.getLinuxFileCategory("hive", "192.168.60.220","root","root",22,"hive-site.xml",filePath);


        /**
         * 上传
         */
        fileManager.upLinuxFileCategory("hive", "192.168.60.220","root","root",22,"hive-site.xml");
