...
public class ZeppelineSite11 {
    public static void main(String[] args) throws Exception {
         ...
         * 下载
         */
//        fileManager.getLinuxFileCategory("zeppeline", "11.11.1.79","root","liwen",22,"shiro.ini","/home/liwen/application/flink/zeppelin/conf");
//        fileManager.getLinuxFileCategory("zeppeline", "11.11.1.79","root","liwen",22,"zeppelin-site.xml","/home/liwen/application/flink/zeppelin/conf");
//        fileManager.getLinuxFileCategory("zeppeline", "11.11.1.79","root","liwen",22,"zeppelin-env.sh","/home/liwen/application/flink/zeppelin/conf");
...
//        fileManager.getLinuxFileCategory("zeppeline", "192.168.60.220","root","root",22,"zeppelin-env.sh",filePath);
         ...
         * 上传
         */
//        fileManager.upLinuxFileCategory("zeppeline", "11.11.1.79","root","liwen",22,"shiro.ini");
//        fileManager.upLinuxFileCategory("zeppeline", "11.11.1.79","root","liwen",22,"zeppelin-site.xml");
        fileManager.upLinuxFileCategory("zeppeline", "11.11.1.79","root","liwen",22,"zeppelin-env.sh");
