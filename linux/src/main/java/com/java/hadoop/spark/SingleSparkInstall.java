 ...
 * 2018-10-30
 */
public class SingleSparkInstall {
...
//			上传java文件 到hadoop用户目录
            ...
            for (Object str : ls) {
                ...
                if (cl.getLongname().endsWith("spark-2.4.0-bin-hadoop2.7.tgz")) {
                    System.out.println(str + "   spark 已经被安装");
                    mark = true;
                    break;
                }
            }
            if (!mark) {
                File javaFile = new File("H:\\开发安装包\\大数据分布式需要的技术\\spark-2.4.0-bin-hadoop2.7.tgz");
//                File javaFile = new File("H:\\hadoop-2.8.5.tar.gz");
            ...
            if (!mark) {
                ...
                String s2 = executeShell("tar zxvf spark-2.4.0-bin-hadoop2.7.tgz  -C /home/hadoop/hadoop");
